...
namespace WebAPI_Farma.pe.Controllers
{
    public class FARMACIAController : ApiController
    {
        ...
        // GET: api/FARMACIA/5
        [ResponseType(typeof(FARMACIA))]
        public IHttpActionResult GetFarmaciaTOP20()
        {
            return Ok(db.USP_TOP20_FARMACIA());
        }

        // GET: api/FARMACIA/5
        [ResponseType(typeof(FARMACIA))]
        public IHttpActionResult GetFarmaciaFitro(string filtro)
        {
            return Ok(db.USP_FARMACIA_X_FILTRO(filtro));
        }
